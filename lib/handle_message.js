...
async function sendMessageOne(msg) {
    ...
    let options = {
        color: '#00ff00',
        title: 'React to Enter the Big Tuna 250k Ton Caught Giveaway!',
        description: '\u200b(React with :fish:)\
\n\n**Reason:** We\'ve caught a *lot* of fish...\
\n\n**Rewards:**\
\n:small_blue_diamond: Gold Chum x1\
\n:small_blue_diamond: Huge Cutbait x5\
\n:small_blue_diamond: Green Banner x1\
\n\n**Ends:** August 1st (Tuesday), 10pm Tokyo Time',
        image: {
            url: 'https://raw.githubusercontent.com/spoink2022/fishing-bot/main/static/img/cosmetics/equipment_banner/green_banner.png'
        }
    };
...
async function editMessageOne(msg, args) {
    ...
    let options = {
        title: 'The 250k Ton Caught Giveaway Has Ended',
        description: '\u200b**Reason:** We\'ve caught a *lot* of fish...\
        \n\n**Rewards:**\
        \n:small_blue_diamond: Gold Chum x1\
        \n:small_blue_diamond: Huge Cutbait x5\
        \n:small_blue_diamond: Green Banner x1\
        \n\n**Ended:** August 1st (Tuesday), 10pm Tokyo Time',
        image: {
            url: 'https://raw.githubusercontent.com/spoink2022/fishing-bot/main/static/img/cosmetics/equipment_banner/green_banner.png'
        }
    };
...
async function getWinnerOne(msg, args) {
    ...
    msg.channel.send(`<@${chosenUserID}>,\n**Congratulations! You have won the Big Tuna 250k Ton Caught Giveaway!**`);
}
