...
async function sendMessageOne(msg) {
    ...
    let options = {
        color: '#00ff00',
        title: 'React to Enter the Halloween Giveaway!',
        description: '\u200b(React with :ghost:)\
\n\n**Reason:** It ain\'t much, but have a happy halloween!\
\n(For those of you asking, the next batch of updates comes in 1-2 weeks)\
\n\n**Rewards:**\
\n:small_orange_diamond: Candy Corn x5\
\n:small_orange_diamond: Corn x50\
\n:small_orange_diamond: S-tier Trophy Coelacanth Card x1\
\n\n**Ends:**  November 6th (Sunday), 8:00pm EDT'
    };
...
async function editMessageOne(msg, args) {
    ...
    let options = {
        title: 'The Halloween Giveaway Has Ended',
        description: '\u200bIt ain\'t much, but have a happy halloween!\
\n(For those of you asking, the next batch of updates comes in 1-2 weeks)\
\n\n**Rewards:**\
\n:small_orange_diamond: Candy Corn x5\
\n:small_orange_diamond: Corn x50\
\n:small_orange_diamond: S-tier Trophy Coelacanth Card x1\
\n\n**Ended:**  November 6th (Sunday), 8:00pm EDT'
    };
...
async function getWinnerOne(msg, args) {
    ...
    msg.channel.send(`<@${chosenUserID}>,\n**Congratulations! You have won the Halloween Giveaway!**`);
}
