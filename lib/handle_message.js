...
async function sendMessageOne(msg) {
    ...
    let options = {
        color: '#00ff00',
        title: 'React to Enter the Big Tuna Easter Giveaway!',
        description: '(React with :egg:)\
\n\n**Reason:** Easter! (Thanks Haku#5721 for sponsoring the Premium Server)\
\n\n**Rewards:**\
\n:rabbit: \\*Bronze Egg x3\
\n:rabbit: \\*Silver Egg x2\
\n:rabbit: \\*Gold Egg x1\
\n:rabbit: Big Tuna Premium Server x1 :sparkles:\
\n:rabbit: Sashimi-Grade XL Fish Card (B-Tier) :sushi:\
\n\n*Pick one for yourself, one for a friend, and one for a different friend\
\n\n**Ends:** May 1st (Sunday), 8:00pm EDT'
    };
...
async function editMessageOne(msg, args) {
    ...
    let options = {
        title: 'The Big Tuna Easter Giveaway Has Ended',
        description: '\u200b\n**Reason:** Easter! (Thanks Haku#5721 for sponsoring the Premium Server)\
\n\n**Rewards:**\
\n:rabbit: \\*Bronze Egg x3\
\n:rabbit: \\*Silver Egg x2\
...
\n:rabbit: Sashimi-Grade XL Fish Card (B-Tier) :sushi:\
\n\n*Pick one for yourself, one for a friend, and one for a different friend\
\n\n**Ended:** May 1st (Sunday), 8:00pm EDT'
    };
...
async function getWinnerOne(msg, args) {
    ...
    msg.channel.send(`<@${chosenUserID}>,\n**Congratulations! You have won the Big Tuna Easter Giveaway!**`);
}
